...
# https://github.com/WangLibo1995/GeoSeg/blob/main/geoseg/models/MANet.py
# Edited : Alabi Bojesomo 
# to accomodate using other timm backbone and also for different number of input channels
...
class MANet(nn.Module):
    def __init__(self, num_channels=3, num_classes=5, backbone_name='resnet50', pretrained=True):
        ...
        try:
            self.backbone = timm.create_model(backbone_name, in_chans=num_channels, features_only=True, 
    #                                           output_stride=32,
